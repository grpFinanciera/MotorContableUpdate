...
if (orderHeader) {
    ...
    inventorySummary = dispatcher.runSync("getProductosInventarioXPedido", [orderItems : orderItems, userLogin : userLogin]);
    ...
    if (productStore) {
        ...
        if (facility != null) {
        inventorySummaryByFacility = dispatcher.runSync("getProductInventorySummaryForItems", [orderItems : orderItems, facilityId : facility.facilityId, userLogin : userLogin]);
