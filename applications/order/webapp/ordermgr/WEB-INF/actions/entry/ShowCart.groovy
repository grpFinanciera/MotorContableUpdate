...
inventorySummary = dispatcher.runSync("getProductosInventarioXPedido", [orderItems : shoppingCart.makeOrderItems(), facilityId : productStoreFacilityId, userLogin : userLogin]);
