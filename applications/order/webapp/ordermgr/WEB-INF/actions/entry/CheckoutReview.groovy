...
impuestos = cart.getImpuestos();
context.impuestos = impuestos;
grandTotal = OrderReadHelper.getOrderGrandTotal(orderItems, orderAdjustments);
context.orderGrandTotal = OrderReadHelper.getOrderTotalConImpuestos(grandTotal, impuestos);
...
context.fechaCreacion = fechaCreacion;

tipoAdjudicacion = cart.getTipoAdjudicacionId();
context.tipoAdjudicacion = tipoAdjudicacion;

subTipoAdjudicacion = cart.getSubTipoAdjudicacionId();
context.subTipoAdjudicacion = subTipoAdjudicacion;

observacion = cart.getObservacion();
