              ...
              //    String accommodationSpotId = shoppingListItem.getString("accommodationSpotId");
               ...
               /*   if (shoppingListItem.get("accommodationMapId") != null) {
                    ...
                    if (UtilValidate.isNotEmpty(configId)) {
                        ...
                        try {
                            listCart.addOrIncreaseItem(productId, null, quantity, reservStart, 
                            		reservLength, reservPersons, null, null, null, null, null, 
                            		attributes, null, configWrapper, null, null, null, dispatcher,
