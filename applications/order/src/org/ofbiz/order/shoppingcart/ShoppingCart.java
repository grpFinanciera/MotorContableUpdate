...
public class ShoppingCart implements Iterable<ShoppingCartItem>, Serializable {
    ...
    private String acctgTransTypeId = null;
    private String tipoAdjudicacionId = null;
    private String medioId = null;
    private String subTipoAdjudicacionId = null;    
    private String observacion = null;
    private String articuloId = null;
    private String fraccionId = null;
    private String numInvitacion = null;
    private Timestamp fechaCreacion = null;
    private Timestamp fechaContable = null;
    private String garantia = null;
    private String pagoAnticipado = null;
    private String proveedorPagoAnticipado = null;
     ...
     * @param tipoAdjudicacionId
     * @param medioId
     * @param subTipoAdjudicacionId
     * @param observacion 
     * @param articuloId
     * @param fraccionId
     * @param numInvitacion
     * @param garantia
     * */
    public ShoppingCart(Delegator delegator, String productStoreId, String webSiteId, Locale locale, String currencyUom, String billToCustomerPartyId, 
    		String billFromVendorPartyId, String acctgTransTypeId, String tipoAdjudicacionId, String medioId, String subTipoAdjudicacionId, String observacion, 
    		String fraccionId, String numInvitacion, String articuloId, String garantia, String pagoAnticipado, String proveedorPagoAnticipado) {
        ...
        this.subTipoAdjudicacionId = subTipoAdjudicacionId;
        ...
        this.proveedorPagoAnticipado = proveedorPagoAnticipado;
    ...
    public ShoppingCart(Delegator delegator, String productStoreId, String webSiteId, Locale locale, String currencyUom) {
        this(delegator, productStoreId, webSiteId, locale, currencyUom, null, null, null, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    public int addOrIncreaseItem(String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
            ...
            String detalleRequisicionId, String requisicionId, String descripcionDetalle, String customTimePeriodId,String mesId,Timestamp fechaEntrega) throws CartItemModifyException, ItemNotFoundException {
    ...
    public int addOrIncreaseItem(String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
        ...
        for (int i = 0; i < this.cartLines.size(); i++) {
            ...
            if(sci.getDetalleRequisicionId() != null){ 
            	if(sci.getRequisicionId().equals(requisicionId) && sci.getDetalleRequisicionId().equals(detalleRequisicionId)){
            		throw new CartItemModifyException("Ya se ingreso este articulo");
            	}
            }
        }
        ...
        if (getOrderType().equals("PURCHASE_ORDER")) {
            ...
            if (supplierProduct != null || "_NA_".equals(this.getPartyId())) {
                 return this.addItem(0, ShoppingCartItem.makePurchaseOrderItem(Integer.valueOf(0), productId, 
                		 ...
                		 shipAfterDate, cancelBackOrderDate, detalleRequisicionId, requisicionId, 
                		 descripcionDetalle,customTimePeriodId,mesId,fechaEntrega));
            } else {
    ...
    public int addItem(int index, ShoppingCartItem item) throws CartItemModifyException {
        ...
        Debug.log("Mike cartLines: " + cartLines);
        Debug.log("Mike cartLines 2: " + item.getDetalleRequisicionId());
...
//    protected String billFromVendorPartyId = null;
  //  protected String shipFromVendorPartyId = null;
    ...
    public List<GenericValue> makeOrderItems(boolean explodeItems, boolean replaceAggregatedId, LocalDispatcher dispatcher) {
        ...
        synchronized (cartLines) {
            ...
            for (ShoppingCartItem item : cartLines) {
                ...
                orderItem.set("detalleRequisicionId", item.getDetalleRequisicionId());
                orderItem.set("requisicionId", item.getRequisicionId());
                orderItem.set("customTimePeriodId", item.getCustomTimePeriodId());
                orderItem.set("cantidadEntregada", BigDecimal.ZERO);
                ...
                Map<String,String> atributos = (Map<String,String>)item.getAttributes();
                for (Map.Entry<String, String> atributo : atributos.entrySet()){
                	if(atributo.getKey().startsWith(UtilClavePresupuestal.ENTITY_TAG_PREFIX)){
                		orderItem.put(atributo.getKey(), atributo.getValue());
                	}
                }
    ...
    public Map makeCartMap(LocalDispatcher dispatcher, boolean explodeItems) {
        ...
        Debug.logInfo("Itemsss: " + result.get("orderItems"),module);
        ...
        result.put("acctgTransTypeId", this.getAcctgTransTypeId());
        ...
        Map<String,Object> atributos = (Map<String,Object>)this.attributes;
        for (Map.Entry<String, Object> atributo : atributos.entrySet()){
        	if(atributo.getKey().startsWith(UtilClavePresupuestal.ENTITY_TAG_PREFIX)){
        		result.put(atributo.getKey(), atributo.getValue());
        	}
        }
    ...
    public void setTipoAdjudicacionId(String tipoAdjudicacionId){
    	this.tipoAdjudicacionId = tipoAdjudicacionId;
    }
    ...
    public void setSubTipoAdjudicacionId(String subTipoAdjudicacionId){
    	this.subTipoAdjudicacionId = subTipoAdjudicacionId;
    }        
    
    public String getTipoAdjudicacionId(){
    ...
    public String getSubTipoAdjudicacionId(){
    	return subTipoAdjudicacionId;
    }
    ...
    public void setFraccionId(String fraccionId){
    	this.fraccionId = fraccionId;
    }
    ...
    public String getProveedorPagoAnticipado(){
    	return proveedorPagoAnticipado;
    }
    
    public void setProveedorPagoAnticipado(String proveedorPagoAnticipado){
    	this.proveedorPagoAnticipado = proveedorPagoAnticipado;
    }
    
    public String getFraccionId(){
    	return fraccionId;
    }
    
    public void setNumInvitacion(String numInvitacion){
    	this.numInvitacion = numInvitacion;
    }
    
    public String getNumInvitacion(){
    	return numInvitacion;
    }
    ...
    public Timestamp getFechaCreacion() {
    	if(fechaCreacion == null){
    		...
    		fechaCreacion = new Timestamp(date.getTimeInMillis());
    		Debug.log("Fecha Creacion: " + fechaCreacion);
    	}
    ...
    public Map<String,BigDecimal> getImpuestos() throws GenericEntityException{
    	Debug.log("JRRM Entra getImpuestos");
    	Map<String,BigDecimal> taxes = new HashMap<String, BigDecimal>();
    	for(ShoppingCartItem  item : cartLines){
    		Map<String,BigDecimal> taxesItem =  item.getImpuestos(this.getFechaCreacion());
    		for (Map.Entry<String,BigDecimal> entry : taxesItem.entrySet()){
    			taxes.put(entry.getKey(),taxes.containsKey(entry.getKey())? taxes.get(entry.getKey()).add(entry.getValue()):entry.getValue());
    		}
    	}
    	Debug.log("JRRM mapa.- "+ taxes);
    	return taxes;
    }
}
