...
<table>
  ...
  <tr>
     <td colspan="3">
<ul>
<#-- <li><a href="<@ofbizUrl>FinAccountMain</@ofbizUrl>">Cuenta Financiera</a></li> -->
...
<br />
  ...
  <tr>
     <td colspan="3">
<ul>
<li><a href="<@ofbizUrl>ListCompanies</@ofbizUrl>">Valores Contables de la Organizaci&oacute;n</a></li>
