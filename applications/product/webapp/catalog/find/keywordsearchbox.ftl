...
<form name="productjumpform" id="productJumpForm" method="post" action="<@ofbizUrl>EditProduct</@ofbizUrl>">
  <fieldset>
    ...
    <select name="DUMMYPAGE" id="dummyPage" onchange="submitProductJump()">
        ...
        <option value="<@ofbizUrl>UpdateProductPublicaciones</@ofbizUrl>">${uiLabelMap.UpdateProductPublicaciones}</option>
        <option value="<@ofbizUrl>UpdateProductGenerales</@ofbizUrl>">${uiLabelMap.UpdateProductGenerales}</option>        
    </select>
  </fieldset>
</form>
