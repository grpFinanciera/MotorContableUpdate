...
public class PartyServices {
    ...
    public static Map<String, Object> createPartyGroup(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        String federalTaxId = (String) context.get("federalTaxId");
        ...
        BigDecimal saldoInicial = (BigDecimal) context.get("saldoInicial");
        Locale locale = (Locale) context.get("locale");
        String organizationPartyId = (String) context.get("organizationPartyId");
...
//				}
                ...
                if (UtilValidate.isNotEmpty(context.get("partyTypeId"))) {
                    ...
                    if (desiredPartyType != null && EntityTypeUtil.isType(desiredPartyType, partyGroupPartyType)) {
                    	roleTypeId = desiredPartyType.getString("partyTypeId");
                    } else {
                ...
                Map<String, Object> newPartyMap = UtilMisc.toMap("partyId", partyId, "partyTypeId", roleTypeId, "createdDate", now, "lastModifiedDate", now);
                if (userLogin != null) {
                    newPartyMap.put("createdByUserLogin", userLogin.get("userLoginId"));
                    newPartyMap.put("lastModifiedByUserLogin", userLogin.get("userLoginId"));
                }
                ...
                String statusId = (String) context.get("statusId");
                String Nivel_id = (String) context.get("Nivel_id");
                ...
                party.set("statusId", statusId);
                party.set("Nivel_id", Nivel_id);
                party.set("state", state);
            ...
            partyGroup.set("rfc", federalTaxId);
            partyGroup.set("regimenId", regimenId);
            partyGroup.set("tamanioAuxiliarId", tamanioAuxiliarId);
            partyGroup.set("sectorEconomicoId", sectorEconomicoId);
            partyGroup.set("origenCapitalId", origenCapitalId);
            ...
            GenericValue SaldoCatalogo = delegator.makeValue("SaldoCatalogo");
            SaldoCatalogo.set("catalogoId",partyId);
            SaldoCatalogo.set("tipoId","PARTY_GROUP");
            SaldoCatalogo.set("partyId",organizationPartyId);
            SaldoCatalogo.set("tipo","A");
            SaldoCatalogo.set("monto",saldoInicial);
            SaldoCatalogo.set("periodo",UtilDateTime.getMonthStart(UtilDateTime.nowSqlDate()));
            SaldoCatalogo.setNextSeqId();
            SaldoCatalogo.create();
