...
MEMIF="-Xms512M -Xmx2536M -XX:MaxPermSize=1024M -noverify"
#MISC="-Duser.language=en"
DEBUGREMOTO="-Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5705"

VMARGS="$MEMIF $MISC $DEBUG $RMIIF $ADMIN $DEBUGREMOTO"
