...
echo on
"%JAVA_HOME%\bin\java" -Xms512M -Xmx8192M -XX:MaxPermSize=1144M -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5005 -noverify -jar ofbiz.jar > runtime\logs\console.log

rem ### Simple easy to read line
rem "%JAVA_HOME%\bin\java" -Xms512M -Xmx3536M -XX:MaxPermSize=1024M -jar ofbiz.jar > runtime\logs\console.log
