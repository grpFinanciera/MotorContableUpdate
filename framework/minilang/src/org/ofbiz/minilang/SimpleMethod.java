...
public class SimpleMethod {
    ...
    public SimpleMethod(Element simpleMethodElement, Map<String, SimpleMethod> parentSimpleMethodsMap, String fromLocation) {
        ...
        cicloName = UtilXml.elementAttribute(simpleMethodElement, "ciclo-name", "ciclo");
    ...
    public String getCicloEnvName(){
    	return this.cicloName;
    }
    ...
    public String exec(MethodContext methodContext) {
        ...
        String ciclo = methodContext.getCiclo();
        ...
        if(ciclo != null){
        	methodContext.putEnv(cicloName, ciclo);
        }
