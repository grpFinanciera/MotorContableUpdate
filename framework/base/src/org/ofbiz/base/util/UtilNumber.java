...
public class UtilNumber {
    ...
    /**
     * Regresa un bigdecimal , si es nulo o vacio lo regresa como CERO '0'
     * @param BigDecimal numero
     */
    public static BigDecimal getBigDecimal(BigDecimal numero){
    	if(UtilValidate.isEmpty(numero))
