...
<@paginate name="proyectoUsuarioListBuilder" list=proyectoUsuarioListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="agregaParticipantes?proyectoId=${row.proyectoId}"/>
