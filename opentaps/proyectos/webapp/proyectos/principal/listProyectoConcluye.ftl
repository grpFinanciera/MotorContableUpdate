...
<@paginate name="proyectoConcluyeListBuilder" list=proyectoConcluyeListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="concluirProyecto?proyectoId=${row.proyectoId}"/>
