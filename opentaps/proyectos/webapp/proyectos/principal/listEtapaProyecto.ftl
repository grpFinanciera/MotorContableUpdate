...
<@paginate name="proyectoEtapaListBuilder" list=proyectoEtapaListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="modificaPresupuesto?proyectoId=${row.proyectoId}"/>
