...
<@paginate name="proyectoDevuelveListBuilder" list=proyectoDevuelveListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="devolverProyecto?proyectoId=${row.proyectoId}"/>
