...
<@paginate name="proyectoInteresComisionListBuilder" list=proyectoInteresComisionListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="registraInteresComision?proyectoId=${row.proyectoId}"/>
