...
<@paginate name="proyectoEtapaModificaListBuilder" list=proyectoEtapaModificaListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.proyectoId href="modificaEtapaPresupuesto?proyectoId=${row.proyectoId}"/>
