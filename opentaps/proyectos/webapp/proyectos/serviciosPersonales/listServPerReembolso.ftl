...
<@paginate name="listServiciosPersReembolso" list=servPerReembolsoListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.servicioPersonalId href="verReembolsoServiciosPersonales?servicioPersonalId=${row.servicioPersonalId}"/>
