...
<@paginate name="listDevoViaticoProyecto" list=viaticoDevuelveProyectoListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.viaticoProyectoId href="devolverViatico?viaticoProyectoId=${row.viaticoProyectoId}"/>
