...
<@paginate name="listViaticoConsulta" list=viaticoConsProyListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.viaticoProyectoId href="verViaticoProyecto?viaticoProyectoId=${row.viaticoProyectoId}"/>
