...
<@paginate name="listAdquisicionPagoConsulta" list=adquisicionesPagoProyListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.adqProyectoId href="verPagoAdquisicion?adqProyectoId=${row.adqProyectoId}"/>
