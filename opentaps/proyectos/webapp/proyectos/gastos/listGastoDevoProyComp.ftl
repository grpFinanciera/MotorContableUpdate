...
<@paginate name="listDevoGastoComprueba" list=gastoCompProyDevoListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.gastoProyectoId href="devolverGastoProyecto?gastoProyectoId=${row.gastoProyectoId}"/>
