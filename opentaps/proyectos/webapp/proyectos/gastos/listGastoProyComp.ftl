...
<@paginate name="listGastoComprueba" list=gastoCompProyListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        ...
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.gastoProyectoId href="comprobarGastoProyecto?gastoProyectoId=${row.gastoProyectoId}"/>
