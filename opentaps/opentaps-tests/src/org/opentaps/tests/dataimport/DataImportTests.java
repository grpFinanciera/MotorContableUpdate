...
public class DataImportTests extends OpentapsTestCase {
    ...
    public void tearDown() throws Exception {
        ...
        DataImportDomainInterface imp_domain = domainLoader.getDomainsDirectory().getDataImportDomain();
    ...
    public void testImportGlAccount() throws Exception {
        ...
        LedgerDomainInterface ledger_domain = domainLoader.getDomainsDirectory().getLedgerDomain();
