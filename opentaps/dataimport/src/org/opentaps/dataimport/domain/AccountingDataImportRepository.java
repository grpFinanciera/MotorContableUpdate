...
public class AccountingDataImportRepository extends DomainRepository implements AccountingDataImportRepositoryInterface{
    ...
    /** {@inheritDoc}. */
    public List<DataImportGlAccount> findNotProcessesDataImportGlAccountEntries(String userLoginId) throws RepositoryException {
        ...
        return this.findList(DataImportGlAccount.class, combinedCond,orderBy);
    }   
}
