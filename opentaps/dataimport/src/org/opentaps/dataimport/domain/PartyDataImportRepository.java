...
public class PartyDataImportRepository extends DomainRepository implements PartyDataImportRepositoryInterface{
	...
	@Override
	public List<DataImportParty> findNotProcessesDataImportPartyEntries(String userLoginId) throws RepositoryException {
		...
		return this.findList(DataImportParty.class, combinedCond);
	}
