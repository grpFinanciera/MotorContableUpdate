...
public class TagDataImportRepository extends DomainRepository implements TagDataImportRepositoryInterface{
    ...
    /** {@inheritDoc}. */
    public List<DataImportTag> findNotProcessesDataImportTags(String userLoginId) throws RepositoryException {
        ...
        return this.findList(DataImportTag.class, combinedCond);
    }
