...
/** {@inheritDoc}. */
public class HistorialBienesDataImportRepository extends DomainRepository implements HistorialBienesDataImportRepositoryInterface{
    
    /**
     * Default constructor.
     */
    public HistorialBienesDataImportRepository() {
        super();
    }
     ...
     */
    public HistorialBienesDataImportRepository(Infrastructure infrastructure, User user) throws RepositoryException {
        super(infrastructure, user);
    }

	@Override
	public List<DataImportHistorialBienes> findNotProcessesDataImportHistorialBienesEntries(String userLoginId) throws RepositoryException {
		...
		return this.findList(DataImportHistorialBienes.class, combinedCond);
	}
