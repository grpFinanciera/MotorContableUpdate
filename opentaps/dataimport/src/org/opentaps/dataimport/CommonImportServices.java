...
public final class CommonImportServices {
     ...
     */
    public static Map<String, Object> uploadFileForDataImport(DispatchContext dctx, Map<String, ? extends Object> context) throws InfrastructureException {
        ...
        String error = "Error en el formato del archivo";
        ...
        try {
            ...
            return UtilMessage.createAndLogServiceError(error, MODULE);
        }
