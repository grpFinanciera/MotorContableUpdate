...
public class OpentapsImporter {
    ...
    public int runImportCustom(String usuarioLogin) throws GenericEntityException {
        ...
        EntityCondition statusCond = EntityCondition.makeCondition(EntityOperator.AND,
        		statusCondPrimera,
                EntityCondition.makeCondition("userLoginId", EntityOperator.EQUALS, usuarioLogin));
        List<EntityCondition> conds = UtilMisc.toList(statusCond);
        if (conditions != null) {
            conds.add(conditions);
        }
