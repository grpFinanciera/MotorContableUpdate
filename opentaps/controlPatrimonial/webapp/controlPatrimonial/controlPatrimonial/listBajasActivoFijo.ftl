...
<@paginate name="activoFijoBajaListBuilder" list=activoFijoBajaListBuilder rememberPage=false>    
    <#noparse>    
        <@navigationHeader/>
        <table class="listTable">
            ...
            <tr class="${tableRowClass(row_index)}">
                <@displayLinkCell text=row.fixedAssetId href="verBajaActivoFijo?fixedAssetId=${row.fixedAssetId}"/>
