              ...
              <form method="post" action="<@ofbizUrl>appendItemToOrder</@ofbizUrl>" name="appendItemForm" style="margin: 0;">
                ...
                <table border="0">
                  ...
                  <tr>
                    ...
                    <@flexArea targetId="ClavePresupuestal" title=uiLabelMap.ClavePresupuestal controlStyle="font-weight: bold;" >
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <#if tagTypes?has_content>
                          ...
                          <@cvePresupSelectRows tags=tagTypes entity=defaultTags! />
                        </#if>
                      </table>
                     </@flexArea>
                    </td>
