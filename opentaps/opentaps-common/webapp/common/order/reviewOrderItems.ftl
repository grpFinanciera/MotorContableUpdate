    ...
    <div class="screenlet-body">
        <table width="100%" border="0" cellpadding="0">
          <tr align="left" valign="bottom">
            ...
            <td width="10%" align="right"><span class="tableheadtext"><b>${uiLabelMap.PurchasingPrecioImpuestos}</b></span></td>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
		                    <#if tagTypes?has_content>
		                      <@cvePresupDisplayForCart tags=tagTypes item=cartLine/>
		                    </#if>
						</tr>
					</table>
				</@flexArea>
          ...
          <#list impuestos.entrySet() as impuesto>
  			<tr>
            <td align="right" colspan="4"><div class="tabletext"><b>${impuesto.key}</b></div></td>
            <td align="right" nowrap="nowrap"><div class="tabletext"><@ofbizCurrency amount=impuesto.value isoCode=currencyUomId/></div></td>
          </tr> 
		  </#list> 
