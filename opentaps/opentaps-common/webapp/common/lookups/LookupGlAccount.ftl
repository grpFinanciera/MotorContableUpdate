    ...
    <table class="listTable">
        ...
        <tr class="class="${tableRowClass(glAccount_index)}">
            <#if parameters.sectionName?default("") == "lookup">
                <@displayLinkCell href="javascript:set_values('${glAccount.glAccountId}','${glAccount.accountName?if_exists}')" text=glAccount.accountCode blockClass="fieldWidth25pct"/>
