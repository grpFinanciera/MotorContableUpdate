...
public class JasperReportsViewHandler extends AbstractViewHandler {
    ...
    Map<FontKey, PdfFont> getPdfFontMap() {
        ...
        key = new FontKey("Times New Roman", false, false);
        font = new PdfFont(fontPath + "/" + "TimesNewRoman.ttf", BaseFont.IDENTITY_H, true);
        fontMap.put(key, font);       
        
        key = new FontKey("Times New Roman", true, false);
        font = new PdfFont(fontPath + "/" + "TimesNewRoman-Bold.ttf", BaseFont.IDENTITY_H, true);
        fontMap.put(key, font);       
        
        key = new FontKey("Times New Roman", false, true);
        font = new PdfFont(fontPath + "/" + "TimesNewRoman-Italic.ttf", BaseFont.IDENTITY_H, true);
        fontMap.put(key, font);  
        
        key = new FontKey("Times New Roman", true, true);
        font = new PdfFont(fontPath + "/" + "TimesNewRoman-BoldItalic.ttf", BaseFont.IDENTITY_H, true);
        fontMap.put(key, font);   
