...
public class PurchaseOrderListView extends EntityListView {
    ...
    protected void init(String entityFindUrl, String entityViewUrl, String idLabel) {
        ...
        ColumnConfig columnOrderId = makeLinkColumn(UtilUi.MSG.productOrderId(), idDefinition, new IntegerFieldDef(PurchaseOrderLookupConfiguration.INOUT_ORDER_ID), entityViewUrl, true);
        columnOrderId.setWidth(20);
        ...
        ColumnConfig columnName = makeColumn(UtilUi.MSG.orderOrderName(), new StringFieldDef(PurchaseOrderLookupConfiguration.INOUT_ORDER_NAME));
        ...
        ColumnConfig columnAmount = makeColumn(UtilUi.MSG.orderAmount(), new StringFieldDef(PurchaseOrderLookupConfiguration.OUT_TOTAL));
