...
public abstract class UtilCommon {
    ...
    public static Map<String, Object> getOrganizationHeaderInfo(String organizationPartyId, Delegator delegator) throws GenericEntityException {
        ...
        // the company name
        if (partyGroup != null && UtilValidate.isNotEmpty(partyGroup.getString("groupNameLocal"))) {
            results.put("organizationCompanyName", partyGroup.getString("groupNameLocal"));
        }
    ...
    /**
     * Obtiene la descripcion de un documento del sistema
     * @param idTipoDoc
     * @param delegator
     * @return
     */
    public static String getDescripcionDoc(String idTipoDoc,Delegator delegator){
    	try {
    		
			GenericValue tipoDocumento = delegator.findByPrimaryKey("TipoDocumento", UtilMisc.toMap("idTipoDoc",idTipoDoc));
			if(UtilValidate.isNotEmpty(tipoDocumento)){
				return tipoDocumento.getString("descripcion");
			}
    ...
    /**
     * Obtiene la descripcion del tipo de adjudicacion
     * @param idTipoDoc
     * @param delegator
     * @return
     */
    public static String getDescripcionTipoAdjudicacion(String tipoAdjudicacionId, Delegator delegator){
    	try {
    		
			GenericValue tipoAdjudicacion = delegator.findByPrimaryKey("TipoAdjudicacion", UtilMisc.toMap("tipoAdjudicacionId",tipoAdjudicacionId));
			if(UtilValidate.isNotEmpty(tipoAdjudicacion)){
				return tipoAdjudicacion.getString("nombreTipoAdjudicacion");
			}
     ...
     * @return
     */
    public static String getDescripcionArticulo(String tipoAdjudicacionId, String articuloId, Delegator delegator){
    	try {
    		
			GenericValue articulo = delegator.findByPrimaryKey("TipoAdjudicacionDoc", UtilMisc.toMap("tipoAdjudicacionId",tipoAdjudicacionId, "docTipoAdjudicacionId", articuloId));
			if(UtilValidate.isNotEmpty(articulo)){
				return articulo.getString("nombreDocumento");
			}
     ...
     * @return
     */
    public static String getDescripcionFraccion(String fraccionId, Delegator delegator){
    	try {
    		
			GenericValue fraccion = delegator.findByPrimaryKey("TipoAdjudicacionArticulo", UtilMisc.toMap("tipoFraccionId",fraccionId));
			if(UtilValidate.isNotEmpty(fraccion)){
				return fraccion.getString("fraccion");
			}
    ...
    public static String getCicloId(HttpServletRequest request) {
        ...
        if (cicloContextSet == null) {
            UtilConfig.checkDefaultCiclo(request);
        }
    ...
    /**
     * Obtiene la descripcion del sub tipo de adjudicacion
     * @param idTipoDoc
     * @param delegator
     * @return
     */
    public static String getDescripcionSubTipoAdjudicacion(String subTipoAdjudicacionId, String tipoAdjudicacionId, Delegator delegator){
    	try {
    		
			GenericValue subTipoAdjudicacion = delegator.findByPrimaryKey("SubTipoAdjudicacion", UtilMisc.toMap("subTipoAdjudicacionId",subTipoAdjudicacionId, "tipoAdjudicacionId",tipoAdjudicacionId));
			return subTipoAdjudicacion.getString("nombreSubTipoAdjudicacion");
    ...
    /**
     * Obtiene la descripcion de Uom Id Unidad de medida
     * @param uomId
     * @param delegator
     * @return
     */
    public static String getDescripcionUomId(String uomId, Delegator delegator){
    	try {
    		
			GenericValue uom = delegator.findByPrimaryKey("Uom", UtilMisc.toMap("uomId",uomId));
			return uom.getString("description");
