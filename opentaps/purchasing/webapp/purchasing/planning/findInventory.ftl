...
<form name="findInventory" method="post" action="<@ofbizUrl>ViewFacilityInventoryByProduct</@ofbizUrl>" id="findInventory">
  ...
  <table class="twoColumnForm">
    ...
    <tr>
      <@inputDateRow name="productsSoldThruTimestamp" title=uiLabelMap.ProductShowProductsSoldThruTimestamp form="findInventory" default=Static["org.ofbiz.base.util.UtilDateTime"].nowSqlDate() />
    </tr>
    <tr>
