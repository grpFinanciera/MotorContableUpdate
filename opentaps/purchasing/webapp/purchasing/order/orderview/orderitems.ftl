    ...
    <div class="screenlet-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr align="left" valign=bottom>
            <td width="20%" align="left"><div class="tableheadtext">${uiLabelMap.ProductProduct}</div></td>
            <th width="10%" align="right">${uiLabelMap.CommonMonth}</th>
          ...
          <#else>
            <#list orderItemList as orderItem>
              ...
              <tr>
                ...
                <#if orderItem.getRelatedOne("StatusItem")?exists>  
					<#assign periodo = orderItem.getRelatedOne("CustomTimePeriod")!'' />
	 				<#assign mes > <#if periodo?has_content> ${periodo.periodName!'N/D'} <#else> N/D </#if> </#assign>
	                  <@displayCell text=mes />
	                  <#-- now show status details per line item -->
	                  <#assign currentItemStatus = orderItem.getRelatedOne("StatusItem")!'' >
						<#assign CIstatus > <#if currentItemStatus?has_content >${currentItemStatus.description!currentItemStatus.statusId} <#else> N/D </#if></#assign>
	                  <td align="left" colspan="1" valign="top">
	                    <div class="tabletext">${uiLabelMap.CommonCurrent}: ${CIstatus}</div>
                  ...
                  <td align="right" valign="top" nowrap="nowrap">
                    <table>
                      <tr valign="top">
                        ...
                        <td>
                        <#if orderItem.orderItemTypeId?has_content && orderItem.orderItemTypeId == "PRODUCT_ORDER_ITEM">
                  ...
                  <td align="right" valign="top" nowrap="nowrap">
                    <div class="tabletext"><@ofbizCurrency amount=orderItem.selectedAmount isoCode=currencyUomId/></div>
                  </td>
                  <td align="right" valign="top" nowrap="nowrap">
                  ...
                  <td align="right" valign="top" nowrap="nowrap">
                    <#if orderItem.statusId?has_content && orderItem.statusId != "ITEM_CANCELLED">
              ...
              <#if (orderItem.orderItemTypeId?exists) && (productId?exists) && (orderItem.orderItemTypeId?has_content && orderItem.orderItemTypeId="PRODUCT_ORDER_ITEM")>
              <#-- INVENTORY -->
              ...
              <#if orderItem.orderItemTypeId?exists && orderItem.orderItemTypeId="PRODUCT_ORDER_ITEM">                           
