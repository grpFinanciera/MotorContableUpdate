    ...
    <fo:page-sequence master-reference="my-page" initial-page-number="1" font-family="Helvetica">
        ...
        <fo:static-content flow-name="xsl-region-after">
            <fo:block border-style="solid" font-size="10pt">
              Por la presente certifico que la informacion en esta factura es verdadera y correcta, asi como que los contenidos de este envio son como se indica arriba.
            </fo:block>
          ...
          <fo:table>
            ...
            <fo:table>
                ...
                <fo:table-header height="14px" font-size="11pt">
                    <fo:table-row>
                        <fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
                            <fo:block font-weight="bold">Codigo</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
                            <fo:block font-weight="bold">${uiLabelMap.CommonDescription}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
                            <fo:block font-weight="bold" text-align="right">Cantidad</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
                            <fo:block font-weight="bold" text-align="right">VALOR UNITARIO</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
                ...
                <fo:table-body font-size="10pt">
                    ...
                    <fo:table-row>
                        ...
                        <fo:table-cell>
                            <fo:block font-weight="bold">Valor de Aduana</fo:block>
                        </fo:table-cell>
                        <fo:table-cell text-align="right">
