...
<@paginate name="listInvoices" list=invoiceListBuilderInvoice rememberPage=false showFromParty=showFromParty showToParty=showToParty showOrderIds=showOrderIds>
    <#noparse>
    <form name="listInvoices" action="invoice.pdf" method="POST" target="_blank" class="basic-form">
        ...
        <table class="listTable">
            <tr class="listTableHeader">
                <@headerCell title=uiLabelMap.FinancialsPreOrden orderBy="createdStamp"/>
                <@headerCell title=uiLabelMap.CommonDescription orderBy="description"/>
                <@headerCell title=uiLabelMap.FinancialsReferenciaFactura orderBy="referenceNumber"/>                
                <#if parameters.showOrderIds><@headerCell title=uiLabelMap.FinancialsOrdenCompra orderBy="orderId"/></#if>
