...
<#if !datos?exists>
<form method="POST" name="ACompensadaE" action="${ACompensadaE}"> <#-- action set by the screen -->
...
<#if datos?exists>
<form method="POST" name="ACompensadaE2" action="${ACompensadaE}"> <#-- action set by the screen -->
  <@inputHidden name="performFind" value="B"/>
  <@inputHidden name="tipoClave" value="EGRESO"/>
  ...
  <table class="twoColumnForm">
     <tbody>
        ...
        <@displayAfectPresupuestariaRow tagTypes=tagTypesEgreso titleClass="requiredField"/>
     </tbody>
  </table>
  <table width=100%>
	<hr>
  ...
  <table class="twoColumnForm">
     <tbody>
        ...
        <tr>
     		<@displayCvesPresupRow tagTypes=tagTypesEgreso titleClass="requiredField"/>
       </tr>
...
<form method="POST" name="ACompensadaE3" action="${ACompensadaE}"> <#-- action set by the screen -->
  <@inputHidden name="agrupadorP" value="${datos.agrupadorP}"/>
