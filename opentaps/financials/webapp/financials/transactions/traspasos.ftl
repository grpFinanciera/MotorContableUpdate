...
<form method="POST" action="<@ofbizUrl>TraspasoPresupuestal</@ofbizUrl>" name=traspasos> <#-- action set by the screen -->
  <div class="form" style="border:0">
    <table class="fourColumnForm" style="border:0">
     ...
     <select name="enumCode" size="1"  >
      ...
      <tr>
    	<@displayTitleCell title=uiLabelMap.FinancialMes />
    	</td>
	    <td>	   	    
     <select name="mesId" size="1"  >
		    	<#list meses as mes>
          ...
          <@inputSubmitRow title=uiLabelMap.FinancialMesBoton />
    </table>
  </div>
</form>
