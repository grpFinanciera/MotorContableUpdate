...
<table>
  <tr><td colspan="7" class="tableheadtext" align="center">${uiLabelMap.FinancialsInventoryValueDetail} para ${parameters.organizationName?if_exists} (${organizationPartyId}) <br/>
...
<tr>
  <td colspan="3" class="tableheadtext">${uiLabelMap.AccountingInventoryItemsSubTotal}</td><td colspan="4" class="tableheadtext" align="right"><@ofbizCurrency amount=total isoCode=currencyUomId/></td>
</tr>
...
<tr><td colspan="7"><hr/></td></tr>
<tr>
  <td colspan="6" class="tableheadtext">${uiLabelMap.AccountingTotalInventoryValue}</td><td colspan="1" class="tableheadtext" align="right"><@ofbizCurrency amount=total isoCode=currencyUomId/></td>
</tr>
</#if>
