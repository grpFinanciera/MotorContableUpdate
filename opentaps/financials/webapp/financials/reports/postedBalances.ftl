...
<div class="treeViewContainer">
    ...
    <div class="tableheadtext" style="margin-top: 20px;">
        ...
        <span style="float:right"><table style="font-weight: bold;" class="twoColumnAmount"><tr><td class="debitAmount">${uiLabelMap.CommonDebit}</td><td class="creditAmount">${uiLabelMap.CommonHaber}</td></tr></table></span>
    </div>
