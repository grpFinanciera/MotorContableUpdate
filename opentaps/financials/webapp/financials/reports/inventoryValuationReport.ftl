...
<table>
  <tr>
     <td colspan="2" class="tableheadtext" align="center">${uiLabelMap.FinancialsInventoryValueByProduct} para ${parameters.organizationName?if_exists} (${organizationPartyId})</td>
  </tr>
  <tr>
