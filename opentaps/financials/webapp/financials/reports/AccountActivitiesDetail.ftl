    ...
    <form method="post" action="<@ofbizUrl>AccountActivitiesDetail</@ofbizUrl>" name="findAccountActivitiesDetail">
      <table>
        ...
        <tr>
          ...
          <@inputLookupCell     name="organizationPartyId" form="findAccountActivitiesDetail" lookup="LookupPartyName" />
        </tr>
        <tr>
...
<@paginate name="myList" list=accountActivitiesDetailsBuilderCustom>
<#noparse >
<div style="margin-bottom: 15px">
  ...
  <table class="listTable" cellspacing="0" style="margin-top:15px; margin-bottom: 15px">
    ...
    <tr class="listTableHeader" style="background-color:white">
      ...
      <@headerCell title=uiLabelMap.PartyParty                     orderBy="organizationPartyId" />
      <@headerCell title=uiLabelMap.PartyName                      orderBy="organizationPartyId" />
    ...
    <#list pageRows as row>
      <tr class="${tableRowClass(row_index)}">
        <td>
          <a href="<@ofbizUrl>AccountActivitiesDetail?glAccountId=${row.glAccountId}&amp;isPosted=</@ofbizUrl>" class="linktext">${row.glAccountId}</a>:
          ${row.glAccountId}
        </td>
        ...
        <@displayLinkCell href="AccountActivitiesDetail?organizationPartyId=${row.organizationPartyId?if_exists}&amp;isPosted="     text=row.organizationPartyId?if_exists />
        <#assign partyName = ""/>
        <#if row.organizationPartyId?exists >
