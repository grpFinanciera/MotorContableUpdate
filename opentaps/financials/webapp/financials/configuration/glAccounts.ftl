...
dojo.declare("opentaps.TrialBalanceAccountTree", opentaps.GLAccountTree, {
    ...
    formatValueNode: function (node, value) {
        ...
        cells += '<td><a href="addSubAccountScreen?parentGlAccountId=' + glAccountId + '&tipoCuentaId=R" class="buttontext">${uiLabelMap.FinancialsAddSubAccount}</a></td>';
        cells += '<td><a href="updateStructureGlAccountScreen?glAccountId=' + glAccountId + '" class="buttontext">${uiLabelMap.FinancialsStructureUpdateGlAccount}</a></td>';
