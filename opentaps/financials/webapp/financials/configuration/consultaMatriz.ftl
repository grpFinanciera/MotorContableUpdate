...
<form name="consultaMatrizForm" method="post" action="">
  ...
  <table class="twoColumnForm">
    ...
    <tbody>    	
      <@inputSelectRow title=uiLabelMap.TipoMatriz required=true list=tipoList displayField="acctgTagUsageTypeId" name="acctgTagUsageTypeId" key="acctgTagUsageTypeId" />      
      <@inputSelectRow title=uiLabelMap.MatrizId required=false list=matrizList  displayField="descripcion" name="matrizId" key="tipoMatrizId" default=matrizId?if_exists />
      ...
      <@inputTextCell name="tipoGasto" size="20" maxlength="20"/>
      </tr>      
