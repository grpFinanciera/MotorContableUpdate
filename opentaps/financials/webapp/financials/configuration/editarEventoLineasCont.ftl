...
<@frameSection title=uiLabelMap.FinancialsEditarEvento >
	<@form name="EditarRegistroEventoLineasCont" url="EditarRegistroEventoLineasCont" >
		...
		<tbody>
			...
			<tr>
				...
				<@inputTextCell name="acctgTransTypeId" readonly=true maxlength=20 default="${eventoContable.acctgTransTypeId}" />
			...
			<tr>
				...
				<@inputTextCell name="moduloId" readonly=true default="${eventoContable.moduloId}"/>
				<@displayTitleCell title=uiLabelMap.TipoPoliza titleClass="requiredField"/>
				<@inputTextCell name="tipoPolizaId" readonly=true default="${eventoContable.tipoPolizaId}" />
			</tr>
			<@displayTitleCell title=uiLabelMap.FinancialPredecesor />
			<@inputTextCell name="predecesor" readonly=true default="${eventoContable.predecesor?if_exists}"/>
				...
				<td colspan="4">
					...
					<#if (contP > 1)>
						...
						<tr id="lineaPres1${contP}">
							...
							<@inputTextCell name="descripcionPresup${contP}" id="descripcionPresup${contP}" readonly=true maxlength=255 default=lineaP.descripcion />
							<@displayTitleCell title=uiLabelMap.FinancialTipoMatriz />
							<@inputTextCell name="tipoMatrizId${contP}" readonly=true default=lineaP.tipoMatrizId?if_exists />
						</tr>
						<tr id="lineaPres2${contP}">
							<@displayTitleCell title=uiLabelMap.CuentaCargo />
							<td>
							<@inputText name="cuentaCargoPresup${contP}" readonly=true default=lineaP.cuentaCargo />
							<@inputText name="comparacion${contP}" id="comparacion${contP}" readonly=true default=lineaP.comparacion?if_exists />
							</td>
							<@displayTitleCell title=uiLabelMap.CuentaAbono />
							<@inputTextCell name="cuentaAbonoPresup${contP}" readonly=true default=lineaP.cuentaAbono/>
						</tr>
						<tr id="lineaPres3${contP}">
							<@displayTitleCell title=uiLabelMap.CatalogoCargo />
							<@inputTextCell name="catalogoCargoPresup${contP}" readonly=true default=lineaP.catalogoCargo?if_exists/>
							<@displayTitleCell title=uiLabelMap.CatalogoAbono />
							<@inputTextCell name="catalogoAbonoPresup${contP}" readonly=true default=lineaP.catalogoAbono?if_exists />
						</tr>
					</#list>
					</tbody>
					</table>
			...
			<tr>
				<td colspan="4">
					...
					<#assign contC = lineaC.secuencia />
					<#if (contC > 1)>
						<tr id="lineaPatriHr${contC}"> <td colspan="2"> <hr>  </hr> </td> </tr>
					</#if>
						<input type="hidden" name="secuenciaLineaCont${contC}" value="${lineaC.secuencia}"/>
						...
						<tr id="lineaPatri4${contC}">
							...
							<#--<@inputCheckboxCell name="excepcion" value="N" onChange="javascript:cambiarValor(this);"/>-->
