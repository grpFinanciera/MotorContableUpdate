...
public final class UtilFinancial {
    ...
    /**
     * Get the <code>EntityExpr</code> for finding GL account classes that are a child of the REVENUE GL Account class ID.
     * @param delegator a <code>Delegator</code> value
     * @return an <code>EntityExpr</code> value
     * @exception GenericEntityException if an error occurs
     */
    public static EntityExpr getRevenueExpr(Delegator delegator) throws GenericEntityException {
        return getGlAccountClassExpr("REVENUE", delegator);
    } 
    /**
     * Get the <code>EntityExpr</code> for finding GL account classes that are a child of the EXPENSE GL Account class ID.
     * @param delegator a <code>Delegator</code> value
     * @return an <code>EntityExpr</code> value
     * @exception GenericEntityException if an error occurs
     */
    public static EntityExpr getExpenseExpr(Delegator delegator) throws GenericEntityException {
        return getGlAccountClassExpr("EXPENSE", delegator);
    }        
    ...
    public static boolean isGlAccountOrganizationInBalance(String organizationPartyId, Delegator delegator, int decimals, RoundingMode rounding) throws GenericEntityException {
        ...
        double debito = Math.abs(debitTotal.doubleValue());
        double credito = Math.abs(creditTotal.doubleValue());
        
        debitTotal = new BigDecimal(debito).setScale(decimals, rounding);
        creditTotal = new BigDecimal(credito).setScale(decimals, rounding);
