...
//        					rows.add(mapa);
    ...
    private static String getNombreGrupoEfectivo(String glAccountClassId){
    	...
    	if (glAccountClassId.equals("IMPUESTOS")){
    		...
    		regresa = "Incremento por Variaci\u00f3n de Inventarios ";
    		...
    		regresa = "Intereses, Comisiones y Otros Gastos De La Deuda P\u00fablica";
    	} else if (glAccountClassId.equals("OGPE")){
    		regresa = "Otros Gastos y P\u00e9rdidas Extraordinarias";
    	} 
