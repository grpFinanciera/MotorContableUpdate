...
public final class PaymentServices {
    ...
    public static Map<String, Object> createPaymentApplication(DispatchContext dctx, Map<String, Object> context) throws GenericServiceException {
        ...
        if (UtilValidate.isNotEmpty(invoiceId)) {
            try {
                InvoiceRepositoryInterface invoiceRepository = new DomainsLoader(new Infrastructure(dispatcher), new User(userLogin)).getDomainsDirectory().getBillingDomain().getInvoiceRepository();
