...
public final class CrmsfaOrderEvents {
     ...
     */
    public static String crmsfaDestroyCart(HttpServletRequest request, HttpServletResponse response) throws GenericEntityException {
     ...
     * @throws GenericEntityException 
     */
    public static String quickCreateOrder(HttpServletRequest request, HttpServletResponse response) throws GenericEntityException {
        HttpSession session = request.getSession(true);
        Delegator delegator = (Delegator) request.getAttribute("delegator");
        ...
        if ((productId != null) && (productId.trim().length() > 0)) {
            ...
            if (productSurvey != null && productSurvey.size() > 0) {
                ...
                try {
                    cart.addOrIncreaseItem(productId, null, quantity, null, null, null, null, null, null, attributes, null, null, null, null, null, dispatcher, null, null, null, null, null,null);
