...
<form name="ConsultaAltas" >
  <table class="twoColumnForm">
    <tbody>
      <@inputHidden name="facilityId" value=facilityId />
      <@inputHidden name="motivoId" value="A" />
   	  <@inputAutoCompleteProductRow name="productId" title=uiLabelMap.ProductProductId />
      <@inputSelectRow title=uiLabelMap.WarehouseVarianceReason required=false list=varianceReasons  displayField="description" name="varianceReasonId" key="varianceReasonId" />
      <@inputDateRangeRow title=uiLabelMap.WarehouseOrderDateAlta fromName="fechaContableDesde" thruName="fechaContableHasta" />     
...
<@import location="component://opentaps-common/webapp/common/includes/lib/opentapsFormMacros.ftl"/>
<@paginate name="paginaAcctgTransAltas" list=physicalListBuilder rememberPage=false>
    <#noparse>
        <@navigationHeader/>
        <table class="listTable">
            <tr class="listTableHeader">
                <@headerCell title=uiLabelMap.FormFieldTitle_numeroPoliza orderBy="agrupador"/>     
                <@headerCell title=uiLabelMap.WarehouseOrderDateAlta orderBy="physicalInventoryDate"/>           
            ...
            <tr class="${tableRowClass(row_index)}">
                ...
                <@displayLinkCell text="Reporte" href="imprimeAltaInventario?acctgTransId=${row.acctgTransId}" />
            </tr>
            </#list>
        </table>
    </#noparse>
