...
/*]]>*/
  ...
  <form method="post" action="<@ofbizUrl>receiveSingleInventoryProduct</@ofbizUrl>" name="selectAllForm" style="margin: 0;">
   ...
   <tr name="item" >
   	  <@inputAutoCompleteProductRow name="productId" title=uiLabelMap.ProductProductId default="" titleClass="requiredField"/>
      <@inputTextRow title=uiLabelMap.ProductItemDescription name="itemDescription" titleClass="requiredField"/>
      ...
      <@inputTextRow rowId="rowProductQuantityAccepted" title=uiLabelMap.ProductQuantityAccepted name="quantityAccepted" default=defaultQuantity?default(1)?string.number size=10 titleClass="requiredField"/>
  ...
  <script type="text/javascript">
    ...
    opentaps.addOnLoad(cambiaEvento(acctgTransTypeId,'2'));
</script>
