...
<@frameSection title=uiLabelMap.ActivoFijoLevantamiento extra=linkInicia >
	<@form name="AgregaActivo" url="AgregaActivo" >
		<table>
			<@inputSelectRow title=uiLabelMap.FormFieldTitle_ubicacionRapidaId name="ubicacionRapidaId" list=listUbicacion key="ubicacionRapidaId" displayField="descripcion" onChange="javascript:borrarIdEnfoca();"/>
